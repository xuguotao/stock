#!/usr/bin/env python3
"""Sync 1-minute trend bars into ClickHouse."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Sync 1-minute A-share trend bars into ClickHouse")
    ...
    parser.add_argument("--max-fetch-symbols", type=int, default=0, help="Max stale symbols per run, 0 means all")
    ...
    result = sync_clickhouse_minute1_kline(
        ...
        max_fetch_symbols=args.max_fetch_symbols,
        progress=report,
    )
